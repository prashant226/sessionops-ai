...
const STATUS_LABEL: Record<string, string> = {
  ...
  EDITED_PENDING_APPROVAL: "Edited · Pending Approval",
  EXCEPTION_PENDING_APPROVAL: "Exception · Pending Approval",
  APPROVED: "Approved",
  CONFIRMED: "Confirmed",
...
const STATUS_STYLE: Record<string, string> = {
  ...
  EDITED_PENDING_APPROVAL: "bg-violet-50 text-violet-700 border-violet-200",
  EXCEPTION_PENDING_APPROVAL: "bg-amber-50 text-amber-800 border-amber-200",
